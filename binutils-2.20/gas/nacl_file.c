...
extern int __real_open(const char *pathname, int oflags, int mode);
extern int __wrap_open(const char *pathname, int oflags, int mode);
extern int __real_close(int dd);
extern int __wrap_close(int dd);
extern int __real_read(int dd, void *, size_t);
extern int __wrap_read(int dd, void *, size_t);
extern int __real_write(int dd, const void *, size_t);
extern int __wrap_write(int dd, const void *, size_t);
extern off_t __real_lseek(int dd, off_t offset, int whence);
extern off_t __wrap_lseek(int dd, off_t offset, int whence);
...
adjust_file_size(int dd, size_t new_size) {
  ...
  /* copy contents over */
  final_base = nacl_files[dd].file_ptr->size & (~0xFFFF);
  ...
  count = nacl_files[dd].file_ptr->size - final_base;
